                ...
                <div class="flip-box">
                    <div class="flip-box-inner">
                        ...
                        <div class="flip-box-back">
                            <a href="{{ url('/sales/schedule') }}"><h2>SCHEDULE APPOINTMENT</h2></a>
            ...
            <li>
                <div class="flip-box">
                    <div class="flip-box-inner">
                        ...
                        <div class="flip-box-back">
                            <a href="{{ url('/sales/client') }}"><h2>CLIENT INFORMATION</h2></a>
                        </div>
                    </div>
                </div>
            </li>
            <li>
                <div class="flip-box">
                    <div class="flip-box-inner">
                        ...
                        <div class="flip-box-back">
                            <a href="{{ url('/sales/create') }}"><h2>CREATE INVOICE</h2></a>
                        </div>
                    </div>
                </div>
            </li>
